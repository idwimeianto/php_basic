<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    if (($error_message === "") AND ($_POST["submit"]=="Update Data")) {
      ...
      $query .= "tanggal_lahir = '$tanggal_lahir', jenis_kelamin='$jenis_kelamin',";
      ...
      if($result) {
        $message = "Mahasiswa dengan nama \"<b>$nama</b>\" dan Nim \"<b>$nim</b>\" sudah berhasil di-update";
  ...
  <section>
    ...
    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="form">
      <div class="mb-3">
        ...
        <input type="text" name="nim" id="nim" class="form-control" value="<?php echo (isset($nim)) ?  $nim : ""; ?>"
          placeholder="Contoh: 1234567">
        <span class="text-muted">(7 digit angka)</span>
      </div>
      <div class="mb-3">
        <label for="nama" class="form-label">Nama</label>
        <input type="text" name="nama" id="nama" class="form-control" value="<?php echo (isset($nama)) ?  $nama : ""; ?>"
          placeholder="Masukkan Nama Kamu">
      </div>
      <div class="mb-3">
        <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
        <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control"
          value="<?php echo (isset($tempat_lahir)) ?  $tempat_lahir : ""; ?>" placeholder="Masukkan Tempat Lahir">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="jurusan" id="jurusan" class="form-control" value="<?php echo (isset($jurusan)) ?  $jurusan : ""; ?>"
          placeholder="Masukkan Jurusan">
      </div>
      <div class="mb-3">
        <label for="ipk">IPK</label>
        <input type="text" name="ipk" id="ipk" class="form-select" value="<?php echo (isset($ipk)) ? $ipk : ""; ?>"
